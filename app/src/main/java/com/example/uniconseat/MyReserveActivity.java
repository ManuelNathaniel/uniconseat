...
public class MyReserveActivity extends BaseActivity {
     ...
     */
    private com.example.test_webview_demo.utils.X5WebView mWebView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mViewParent = (ViewGroup) findViewById(R.id.mywebView1);
    ...
    private void initProgressBar() {
        mPageLoadingProgressBar = (ProgressBar) findViewById(R.id.myprogressBar1);// new
    ...
    private void initBtnListenser() {
        mBack = (ImageButton) findViewById(R.id.mybtnBack1);
        mForward = (ImageButton) findViewById(R.id.mybtnForward1);
        mExit = (ImageButton) findViewById(R.id.mybtnExit1);
        mHome = (ImageButton) findViewById(R.id.mybtnHome1);
        mGo = (Button) findViewById(R.id.mybtnGo1);
        mUrl = (EditText) findViewById(R.id.myeditUrl1);
        mMore = (ImageButton) findViewById(R.id.mybtnMore);
        if (Integer.parseInt(android.os.Build.VERSION.SDK) >= 16) {
            mBack.setAlpha(disable);
            mForward.setAlpha(disable);
            mHome.setAlpha(disable);
        ...
        mMore.setOnClickListener(new OnClickListener() {
            ...
            @Override
            public void onClick(View v) {
                Toast.makeText(getApplicationContext(), "暂无相关功能",
            ...
            public void onFocusChange(View v, boolean hasFocus) {
                if (hasFocus) {
                    ...
                    if (mWebView.getUrl().equalsIgnoreCase(mHomeUrl)) {
                        mUrl.setText("");
                        mGo.setText("首页");
                        mGo.setTextColor(0X88888888);

                    } else {
                        mUrl.setText(mWebView.getUrl());
                        mGo.setText("进入");
                        mGo.setTextColor(0XFFFF00FF);
                    }
                } else {
